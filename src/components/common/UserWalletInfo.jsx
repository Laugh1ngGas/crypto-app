...
const UserWalletInfo = ({ user }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      <div className="group cursor-pointer w-12 h-12 rounded-full bg-neutral-900 hover:bg-neutral-800 flex items-center justify-center">
        <SettingsIcon className="w-5 h-5 text-neutral-400 group-hover:text-white" />
      </div>
      <div className="relative">
        <div
          className="group flex items-center gap-2 bg-neutral-900 hover:bg-neutral-800 px-3 py-2 rounded-full text-white cursor-pointer"
          onClick={toggleMenu}
        >
      ...
      {menuOpen && (
        <div className="absolute right-0 mt-2 bg-neutral-900 border border-neutral-700 rounded-b-md rounded-t-none shadow-lg z-50 min-w-[200px]">
          <ul>
