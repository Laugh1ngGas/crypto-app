  ...
  {navItems.map((item, index) => (
    ...
    >
      ...
      {item.submenu && openMenu === item.label && (
        <ul
          className="absolute bg-neutral-900 border border-neutral-700 rounded-b-md rounded-t-none shadow-lg z-10 min-w-[160px]"
        >
          ...
          <div className="hidden lg:flex justify-center space-x-8 items-center">
            ...
            <Link to="/signup" className="bg-gradient-to-r from-orange-500 to-orange-800 py-2 px-3 rounded-md">Sign Up</Link>
          </div>
